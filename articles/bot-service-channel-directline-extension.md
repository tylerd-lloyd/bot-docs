...
Streaming extensions expand on the use of the WebSocket and allows **all messaging communication** to be sent on that WebSocket. Streaming extensions can also be used between channel services and the bot.
